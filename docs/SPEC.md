...
- R31. A map can be marked fully lit (daylight) in the Map tab: every cell counts as bright and players see everything in line of sight from where they stand, as far as walls allow. Issue #26.
